namespace Greg.Xrm.ModernThemeBuilder.Views
{
	partial class PaletteEditorView
	{
		...
		private void InitializeComponent()
		{
			...
			this.hex05 = new System.Windows.Forms.Label();
			...
			this.color08 = new System.Windows.Forms.Label();
			this.color07 = new System.Windows.Forms.Label();
			this.color06 = new System.Windows.Forms.Label();
			this.color05 = new System.Windows.Forms.Label();
			this.color04 = new System.Windows.Forms.Label();
			this.color03 = new System.Windows.Forms.Label();
			this.color02 = new System.Windows.Forms.Label();
			this.color01 = new System.Windows.Forms.Label();
			this.label08 = new System.Windows.Forms.LinkLabel();
			this.label07 = new System.Windows.Forms.LinkLabel();
			this.label06 = new System.Windows.Forms.LinkLabel();
			this.label05 = new System.Windows.Forms.LinkLabel();
			this.label04 = new System.Windows.Forms.LinkLabel();
			this.label03 = new System.Windows.Forms.LinkLabel();
			...
			this.hex08.TabIndex = 58;
			this.hex08.Tag = "8";
			this.hex08.Text = "#FFFFFF";
			this.hex08.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// hex07
			// 
			...
			this.hex07.TabIndex = 57;
			this.hex07.Tag = "7";
			this.hex07.Text = "#FFFFFF";
			this.hex07.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// hex06
			// 
			...
			this.hex06.TabIndex = 56;
			this.hex06.Tag = "6";
			this.hex06.Text = "#FFFFFF";
			this.hex06.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// hex05
			// 
			...
			this.hex05.TabIndex = 55;
			this.hex05.Tag = "5";
			this.hex05.Text = "#FFFFFF";
			this.hex05.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// hex04
			// 
			...
			this.hex04.TabIndex = 54;
			this.hex04.Tag = "4";
			this.hex04.Text = "#FFFFFF";
			this.hex04.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// hex03
			// 
			...
			this.hex03.TabIndex = 53;
			this.hex03.Tag = "3";
			this.hex03.Text = "#FFFFFF";
			this.hex03.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// hex02
			// 
			...
			this.hex02.TabIndex = 52;
			this.hex02.Tag = "2";
			this.hex02.Text = "#FFFFFF";
			this.hex02.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// hex01
			// 
			...
			this.hex01.TabIndex = 51;
			this.hex01.Tag = "1";
			this.hex01.Text = "#FFFFFF";
			this.hex01.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// color08
			// 
			...
			this.label08.TabIndex = 42;
			this.label08.TabStop = true;
			this.label08.Tag = "8";
			this.label08.Text = "Foreground Selected";
			// 
			// label07
			// 
			...
			this.label07.TabIndex = 41;
			this.label07.TabStop = true;
			this.label07.Tag = "7";
			this.label07.Text = "Background Selected";
			// 
			// label06
			// 
			...
			this.label06.TabIndex = 40;
			this.label06.TabStop = true;
			this.label06.Tag = "6";
			this.label06.Text = "Foreground Pressed";
			// 
			// label05
			// 
			...
			this.label05.TabIndex = 39;
			this.label05.TabStop = true;
			this.label05.Tag = "5";
			this.label05.Text = "Background Pressed";
			// 
			// label04
			// 
			...
			this.label04.TabStop = true;
			this.label04.Tag = "4";
			this.label04.Text = "Foreground Hover";
			// 
			// label03
			// 
			...
			this.label03.TabIndex = 37;
			this.label03.TabStop = true;
			this.label03.Tag = "3";
			this.label03.Text = "Background Hover";
			// 
			// label02
			// 
			...
			this.label02.TabStop = true;
			this.label02.Tag = "2";
			this.label02.Text = "Foreground";
			// 
			// label01
			// 
			...
			this.label01.TabIndex = 35;
			this.label01.TabStop = true;
			this.label01.Tag = "1";
			this.label01.Text = "Background";
			// 
			// label1
			// 
    ...
    " sample.";
			...
			this.Controls.Add(this.hex05);
			this.Controls.Add(this.hex04);
			this.Controls.Add(this.hex03);
			this.Controls.Add(this.hex02);
			this.Controls.Add(this.hex01);
			this.Controls.Add(this.color08);
			this.Controls.Add(this.color07);
			this.Controls.Add(this.color06);
			this.Controls.Add(this.color05);
			this.Controls.Add(this.color04);
			this.Controls.Add(this.color03);
			this.Controls.Add(this.color02);
			this.Controls.Add(this.color01);
		...
		private System.Windows.Forms.Label hex08;
		private System.Windows.Forms.Label hex07;
		private System.Windows.Forms.Label hex06;
		private System.Windows.Forms.Label hex05;
		...
		private System.Windows.Forms.Label color08;
		private System.Windows.Forms.Label color07;
		private System.Windows.Forms.Label color06;
		private System.Windows.Forms.Label color05;
		private System.Windows.Forms.Label color04;
		private System.Windows.Forms.Label color03;
		private System.Windows.Forms.Label color02;
		private System.Windows.Forms.Label color01;
		private System.Windows.Forms.LinkLabel label08;
		private System.Windows.Forms.LinkLabel label07;
		private System.Windows.Forms.LinkLabel label06;
		private System.Windows.Forms.LinkLabel label05;
		private System.Windows.Forms.LinkLabel label04;
		private System.Windows.Forms.LinkLabel label03;
