...
namespace Greg.Xrm.ModernThemeBuilder
{
	...
	[Export(typeof(IXrmToolBoxPlugin)),
		ExportMetadata("Name", "_n.ModernThemeBuilder"),
		ExportMetadata("Description", "Set up and deploy modern theme for power apps"),
	...
	public class ModernThemeBuilderPlugin : GregPluginBase
	{
		public override IXrmToolBoxPluginControl GetControl()
		{
			var settingsProvider = new SettingsProvider<Settings, ModernThemeBuilderPlugin>();
			var themeProvider = new Theming.ThemeProvider();

			return new Views.MainView(settingsProvider, themeProvider).SetIcon();
		}

		/// <summary>
		/// Constructor 
		/// </summary>
		public ModernThemeBuilderPlugin()
		{
